...

{
    ...
    {
        public static string CookedPath(MEGame game, string forcedPath = null)
        {
            switch (game)
            {
                case MEGame.ME1:
        ...
        public static string BioGamePath(GameTarget target) => Path.Combine(target.TargetPath, target.Game == MEGame.ME3 ? "BIOGame" : "BioGame"); //all games use same biogame path.


        public static Dictionary<string, string> OfficialDLCNames(MEGame game)
        {
            switch (game)
            {
                case MEGame.ME1:
        ...
        /// <returns></returns>
        public static string ExecutablePath(MEGame game, string rootPath)
        {
            switch (game)
            {
                case MEGame.ME1:
        ...
        /// <param name="game"></param>
        /// <returns></returns>
        internal static string DLCPath(string gameRoot, MEGame game)
        {
            if (game == MEGame.ME1) return Path.Combine(gameRoot, @"DLC");
            if (game == MEGame.ME3) return Path.Combine(gameRoot, "BioGame", @"DLC");
            if (game == MEGame.ME3) return Path.Combine(gameRoot, "BIOGame", @"DLC");
            return null;
        }
        ...
        /// <param name="game"></param>
        /// <returns></returns>
        internal static string LODConfigFile(MEGame game)
        {
            switch (game)
            {
                case MEGame.ME1:
        ...
        public static string[] ExecutableNames(MEGame game)
        {
            switch (game)
            {
                case MEGame.ME1:
        ...
        public static List<string> VanillaDlls(MEGame game)
        {
            switch (game)
            {
                case MEGame.ME1:
