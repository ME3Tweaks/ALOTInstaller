...
#region Static Property Changed
        ...
        */
        ...
        public static void Load()
        {
            ...
            DuplicatingIni settingsIni = null;
            try
            {
            ...
            TextureLibraryLocation = LoadDirectorySetting(settingsIni, "ALOTInstallerCore", SettingsKeys.SettingKeys.BuildLocation, @"Downloaded_Mods");
            BuildLocation = LoadDirectorySetting(settingsIni, "ALOTInstallerCore", SettingsKeys.SettingKeys.BuildLocation, @"Staging");
        ...
        private static string LoadDirectorySetting(DuplicatingIni ini, string section, SettingsKeys.SettingKeys key,
            string defaultSubfolder)
        {
            string dir = ini[@"ALOTInstallerCore"][SettingsKeys.SettingsKeyMapping[key]]?.Value;
